...
const Hero = () => {
  return (
    <div
  id="hero"
  className=" min-h-screen bg-no-repeat bg-[url(/banner-bg.png)] bg-cover"
      ...
      <div className="container grid lg:grid-cols-2 h-[calc(100vh-60px)]">
        ...
        <div className="text-[70px] sm:text-[100px] font-bold leading-tight flex justify-center items-center text-white">
          <div>
            ...
            <p data-aos="zoom-in-up" className="  ">Muhammad</p>
            <p data-aos="zoom-in-up" className="text-[#7ed627]">Abdullah</p>
          </div>
        </div>
      </div>
    </div>
